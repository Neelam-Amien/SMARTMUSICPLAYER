...
public class Happy_Mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_happy__mode);
        setTitle("Happy Mode");
        recyclerView=findViewById(R.id.recyclerView1);

        SharedPreferences sharedPreferences=getSharedPreferences("Happymode",MODE_PRIVATE);
        wordsString=sharedPreferences.getString("hsong","");
    ...
    private void sendInfoPlay(String songname,int pos){
        Intent intent=new Intent(Happy_Mode.this,PlayMusic.class);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()){
                    case R.id.remove:
                        ...
                        editor.putString("hsong",wordsString);
                        editor.apply();
                        loadList();
